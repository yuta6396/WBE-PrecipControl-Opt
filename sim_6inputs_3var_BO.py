...
max_iter_vec = [2, 3]            #{10, 20, 20, 50]=10, 30, 50, 100と同値
...
base_dir = f"test_result/6inputs_3var_BO/1200sec_{Opt_purpose}_{input_var}_seed={trial_base}-{trial_base+trial_num -1}_{current_time}/"
